...
export const industryProfiles: IndustryProfile[] = [
  ...
  },
  {
    id: "beauty",
    label: "美业",
    match: /美发|美容|美甲|皮肤|理疗|spa|SPA/,
    hookLead: "试",
    painLead: ["网图和实际效果经常差很远", "产品、手法和卫生，只有到店才看得出"],
    proofLead: ["真实到店体验和前后对比，比修图可靠", "老师的手法与用料，眼见为实"],
    offerLead: "我整理了一份到店前的确认清单",
    ctaLead: "想要确认清单，评论区打",
  },
  {
    id: "pet",
    ...
    match: /宠物|猫|狗|宠物店|洗护/,
    hookLead: "挑",
    painLead: ["宠物洗护寄养，最怕卫生和态度问题", "环境、消毒和资质，光看照片判断不了"],
    proofLead: ["店内环境和洗护过程实拍，最直观", "老客户愿意复购，才是真的放心"],
    offerLead: "我整理了一份宠物店考察清单",
    ctaLead: "想要考察清单，评论区打",
  },
  {
    id: "childcare",
    label: "母婴亲子",
    match: /母婴|亲子|儿童|遛娃|早教|乐园/,
    hookLead: "带娃",
    painLead: ["遛娃去处人挤人，孩子玩不开心家长也累", "安全和卫生，比好玩更重要"],
    proofLead: ["真实遛娃动线，避开人流和排队", "亲子家庭最在意的细节，实地才看得出来"],
    offerLead: "我整理了一份顺路不踩坑的遛娃清单",
    ctaLead: "想要遛娃清单，评论区打",
  },
];
